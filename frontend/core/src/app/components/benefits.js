...
export default function Benefits({ icon, title, body }) {
  return (
    <div className=" flex flex-col items-end gap-4 rounded-2xl border-2 border-royale-green-dark bg-royale-green-dark p-7 text-right text-sky-blue duration-300  ease-in-out hover:border-sky-blue hover:shadow-inner">
