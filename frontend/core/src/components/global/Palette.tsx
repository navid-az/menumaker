...
const Palette = ({
  ...
  return (
    <div className="flex h-10 flex-1 flex-row-reverse rounded-2xl border-primary bg-white outline outline-2 outline-primary">
      {colors.map((color, index) => (
        <div
          className="group flex flex-1 cursor-pointer items-center justify-center gap-4 rounded-none transition-all first:rounded-l-2xl last:rounded-r-2xl hover:basis-3/12"
          style={{
